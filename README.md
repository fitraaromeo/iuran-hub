...
Aplikasi web modern berbasis **Vite + React (Frontend)** dan **Laravel 11 (Backend API)** yang dirancang khusus untuk mempermudah tugas Pak RT dalam mengelola keuangan, mendata hunian warga, menagih iuran bulanan secara otomatis, mengelola pengeluaran kas, serta menghasilkan buku kas bulanan siap cetak secara profesional.
...
2. Jalankan file installer `.msi` (Windows) dan klik **Next** hingga selesai.  
   *(Pastikan opsi "Add to PATH" dalam keadaan tercentang)*
...
4. Buat database kosong:
   ...
   - Klik **OK**
   - *(Username default: `root`, Password: kosong/tidak ada)*
